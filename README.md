...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,100:0f172a&height=160&section=header&text=Currency%20Converter%20Utility&fontSize=42&fontColor=38bdf8&fontFamily=Outfit" width="100%" />
</div>
...
A simple utility script for real-time currency conversion calculations featuring dynamic DOM updates.
...
### ⚙️ Quick Start Steps
```bash
    git clone https://github.com/Sayed-Herzallah/currency-converter-utility.git
    cd currency-converter-utility
